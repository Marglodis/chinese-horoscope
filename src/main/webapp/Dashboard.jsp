...
<link href="assets/css/styles.css" rel="stylesheet" type="text/css"> 
    <!-- Fondo alegórico al horóscopo chino con opacidad -->
    <style>
        ...
        .row {
            margin-top: 120px; /* Ajusta el margen superior para que los botones estén casi centrados verticalmente */
        }

        .col-md-3 {
            margin-bottom: 20px; /* Agrega espacio entre los botones */
        }
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center text-danger">Bienvenido, <c:out value="${sessionScope.usuario.nombre}" /></h2>
